...
"""
    The wdcggStation module is used to explore ICOS CP WdcggStations' metadata.

    Example usage:

    From wdcggStation import WdcggStation
...
if __name__ == '__main__':
    ...
    doctest.testmod(extraglobs={'t': WdcggStation(limit=10)},
