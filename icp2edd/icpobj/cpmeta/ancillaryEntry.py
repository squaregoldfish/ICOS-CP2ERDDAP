...
"""
    The ancillaryEntry module is used to explore ICOS CP cpmeta::AncillaryEntrys' metadata.

    Example usage:

    from cpmeta import AncillaryEntry
...
_attr = {
    "cpmeta:hasAncillaryDataValue": "ancillary_data_value",  # rdfs:Literal
    "cpmeta:hasAncillaryObjectValue": "ancillary_value",  # cpmeta/AncillaryValue
}
...
if __name__ == "__main__":
    ...
    doctest.testmod(
        extraglobs={"t": AncillaryEntry(limit=10)},
