...
"""
    The ingosStation module is used to explore ICOS CP cpmeta::IngosStations' metadata.

    Example usage:

    from cpmeta import IngosStation
...
class IngosStation(Station):
    ...
    def __init__(self, limit=None, uri=None):
        ...
        :param uri: ICOS CP URI ('http://meta.icos-cp.eu/resources/stations/INGOS_GIF')
        """
        super().__init__()
...
if __name__ == "__main__":
    ...
    doctest.testmod(
        extraglobs={"t": IngosStation(limit=10)},
