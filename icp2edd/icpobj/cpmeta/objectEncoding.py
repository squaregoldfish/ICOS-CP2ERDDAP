...
"""
    The objectEncoding module is used to explore ICOS CP cpmeta::ObjectEncodings' metadata.

    Example usage:

    from cpmeta import ObjectEncoding
...
# ----------------------------------------------
class ObjectEncoding(FileFormat):
    """
    >>> t.getMeta()
    >>> t.show(True)
    ...
    def __init__(self, limit=None, uri=None):
        """initialise instance of ObjectEncoding(FileFormat).
        ...
        :param uri: ICOS CP URI ('http://meta.icos-cp.eu/ontologies/cpmeta/plainFileEncoding')
        """
        super().__init__()
...
if __name__ == "__main__":
    ...
    doctest.testmod(
        extraglobs={"t": ObjectEncoding(limit=10)},
