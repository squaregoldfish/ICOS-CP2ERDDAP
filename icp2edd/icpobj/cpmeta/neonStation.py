...
"""
    The neonStation module is used to explore ICOS CP cpmeta::NeonStations' metadata.

    Example usage:

    from cpmeta import NeonStation
...
class NeonStation(Station):
    ...
    def __init__(self, limit=None, uri=None):
        ...
        :param uri: ICOS CP URI ('http://meta.icos-cp.eu/resources/stations/NEON_BARC')
        """
        super().__init__()
...
if __name__ == "__main__":
    ...
    doctest.testmod(
        extraglobs={"t": NeonStation(limit=10)},
