...
"""
    The os module is used to explore ICOS CP cpmeta::OSs' metadata.

    Example usage:

    from cpmeta import OS
...
class OS(IcosStation):
    ...
    def __init__(self, limit=None, uri=None):
        ...
        :param uri: ICOS CP URI ('http://meta.icos-cp.eu/resources/stations/OS_PS-VOS')
        """
        super().__init__()
