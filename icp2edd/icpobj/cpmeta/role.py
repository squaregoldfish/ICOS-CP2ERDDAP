...
"""
    The role module is used to explore ICOS CP cpmeta::Roles' metadata.

    Example usage:

    from cpmeta import Role
...
class Role(ICPObj):
    ...
    def __init__(self, limit=None, uri=None):
        ...
        :param uri: ICOS CP URI ('http://meta.icos-cp.eu/resources/roles/Engineer')
        """
        super().__init__()
